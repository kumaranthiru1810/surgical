...
<body class="bg-light">
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form method="POST" id="complaintForm" action="./submit_complaint.php">
                            <!-- <div class="mb-3">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary px-4 comp-btn" id="submitButton" disabled><i class="bi bi-send"></i> Submit Complaint</button>
                            </div>
    ...
    <script>
        ...
        document.getElementById('complaintForm').addEventListener('submit', function(e) {
            ...
            message += `Coutry : <?php echo $country; ?>%0A%0A`;
            message += `Pincode : <?php echo $data['pin']; ?>%0A%0A`;
