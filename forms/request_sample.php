    ...
    <div class="container place_order">
        <div class="row mb-3">
            <div class="col-12 text-center page-header">
                <h3><i class="bi bi-cart-check me-2"></i> REQUEST SAMPLE</h3>
                <p class="lead mb-0">Fill out the form below to request a sample of our products</p>
            </div>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary btn-md submit-btn comp-btn" id="submitButton" disabled>
                                    <i class="bi bi-cart-check-fill me-2"></i>Request Sample
                                </button>
                            </div>
                        </div>
